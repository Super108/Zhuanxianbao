...
-(void)httpRequestSend:(NSString *)url parameter:(NSDictionary *)parameter backBlock:(void (^)(NSDictionary *))backBlock{
    ...
    NSData *result = [NSJSONSerialization dataWithJSONObject:parameter options:kNilOptions error:&error];

    NSString *pageSource = [[NSString alloc] initWithData:result encoding:NSUTF8StringEncoding];
    
    NSStringEncoding gbkEncoding = CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000);
    
    [request setHTTPBody:[pageSource dataUsingEncoding:gbkEncoding]];
...
//    NSLog(@"connectio nDidFinishLoading");
