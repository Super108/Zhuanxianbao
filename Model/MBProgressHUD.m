...
- (void)layoutSubviews {
    ...
    NSDictionary *dic = [[NSDictionary alloc] initWithObjectsAndKeys:label.font,NSFontAttributeName, nil];
    
    CGSize labelSize = [label.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    ...
    NSDictionary *dic1 = [[NSDictionary alloc] initWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName,paragraphStyle,NSParagraphStyleAttributeName, nil];
    
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:dic1 context:nil].size;
